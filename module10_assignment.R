...
getwd()
setwd("E:/Users/Paul/Google Drive/School Work/Practical Data Science/Week10")
  ...
  sidebarLayout(
    ...
    sidebarPanel(
     ## selectInput(inputId = "mynumber", label = "Choose a Number", choices = 1:5)),
      ...
      selectInput(inputId = "subset_income", label = "subset income",
                  choices = unique(income$income)),
      # Interactive piece 2: inputId = "set_yaxis"
      selectInput(inputId = "set_yaxis", label = "set yaxis",
                  choices = c(HoursPerWeek = "hours_per_week", CaptialLoss = "capital_loss")),
      # Interactive piece 3: inputId = "subset_occupation"
      checkboxGroupInput("subset_occupation", "Include Occupations:",
